...
Description: Add a advertising widget to your sidebar.
Version: 1.0
Author: Medust
...
class AdBoxWidget extends WP_Widget {
	...
	public function widget($args, $instance) {
		...
		$ad_main_title = '';
		$ad_main_description = '';
		$ad_sponsor = '<div style="float:right;font-weight:normal; font-size:12px; color:#999">Powered by <a href="#">Ad Box</a> from <a href="#">Medust</a></div>
